<template>
  <q-page class="row q-pa-md q-gutter-sm">
    <div class="col">
      <q-item-label style="font-size: 16px" class="text-weight-medium text-indigo-10">Tambah Penduduk</q-item-label>
      <q-item-label style="font-size: 12px" class="text-caption text-grey-6 q-mb-md">Fitur ini digunakan untuk menambahkan
        data penduduk, terdapat juga
        fitur edit dan delete data yang dapat digunakan apabila terjadi
        kesalahan pada saat penginputan data.</q-item-label>
